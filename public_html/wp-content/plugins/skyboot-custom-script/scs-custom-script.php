...
Description:  Insert your Custom CSS and Custom JS in Header & Footer tag. like: Facebook pixel code, google analytics code, GA4 property code, etc.
Version:      1.0.4
Author:       skybootstrap
...
*/
	...
	define( 'SCS_CUSTOM_SCRIPT_VERSION', '1.0.4' );
